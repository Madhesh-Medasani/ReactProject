                                ...
                                <div>
                                    <div className="sub sub-card-display">
                                        ...
                                        <div className="sub-card ">
                                            <p className="sub-card-text">GST Invoice & Bulk Discounts</p>
                                            <p className="sub-card-text1">Save up to 28% more with GST input credit and avail discounts on multi-unit purchases.</p>
                                        </div>
                                    </div>
                                    <div className="sub sub-card-display">
